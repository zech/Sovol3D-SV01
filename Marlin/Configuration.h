...
#define STRING_CONFIG_H_AUTHOR "Tim Zech" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sovol3D SV01"
 ...
 *                                         X,      Y,      Z,      E0     [, E1[, E2...]]
 */
// Original Sovol3D SV01 Marlin 2.0:      80.00,  80.00, 400.00,  415.00
// The following values are derived from the original firmware values
// Stepping for XYZ is 1/32 (2x); Stepping for E0 is 1/64 (4x)
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  160.00, 160.00, 800.00, 1600.00 }
...
// Original Sovol3D SV01 Marlin 2.0
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (Y_BED_SIZE / 2) - 2.5  // Y point for Z homing when homing all axes (G28).
#endif
